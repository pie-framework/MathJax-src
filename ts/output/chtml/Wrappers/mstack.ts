...
import { CommonMstackMixin } from '../../common/Wrappers/mstack.js';
import { CHTMLmtr } from './mtr.js';
import { CHTMLmtd } from './mtd.js';
import { MmlMstack } from '../../../core/MmlTree/MmlNodes/mstack.js';
 ...
 */
export class CHTMLmstack<N, T, D> extends CommonMstackMixin<
  CHTMLmtd<any, any, any>,
  CHTMLmtr<any, any, any>,
  CHTMLConstructor<any, any, any>
>(CHTMLWrapper) {
  /**
   * The mtable wrapper
   */
  public static kind = MmlMstack.prototype.kind;
  ...
  public toCHTML(parent: N) {
    ...
    const createRow = (maxCols: number) => (rowData: any[]) => {
      const tr = ce('tr');
    ...
    const generateStack = (rows: any[][], parent: HTMLElement) => {
