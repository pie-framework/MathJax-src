 ...
 */
export interface CommonMstack<C extends AnyWrapper, R extends CommonMtr<C>>
  extends AnyWrapper {
  /**
 ...
 */
export type MstackConstructor<
  C extends AnyWrapper,
  R extends CommonMtr<C>
> = Constructor<CommonMstack<C, R>>;
 ...
 */
export function CommonMstackMixin<
  C extends AnyWrapper,
  R extends CommonMtr<C>,
  T extends WrapperConstructor
>(Base: T): MstackConstructor<C, R> & T {
